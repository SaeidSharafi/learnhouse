...
export default function ActivityNavigation(props: ActivityNavigationProps): React.ReactNode {
  ...
  return (
    <>
      ...
      {!isBottomNavVisible && (
        <div className="fixed bottom-8 start-1/2 transform -translate-x-1/2 rtl:translate-x-1/2 z-sticky-header w-[85%] sm:w-auto sm:min-w-[350px] max-w-lg transition-all duration-300 ease-in-out">
          <div 
