        ...
        <>
          ...
          >
            <div
              ...
              className={`bg-black z-[10000] shadow-lg ring-1 ring-inset ring-white/10 text-white p-4 backdrop-blur-md transition-all duration-300 flex flex-col rounded-2xl max-w-(--breakpoint-2xl) w-10/12 mx-auto fixed bottom-4 start-1/2 transform -translate-x-1/2 rtl:translate-x-1/2 ${
    ...
    <div className={`flex space-x-3 w-full antialiased ${isAI ? 'items-start' : 'items-start'}`}>
      ...
      <div className="flex-1 min-w-0">
        {isAI ? (
          ...
          <div className="inline-block bg-white/5 rounded-xl rounded-ts-sm px-3 py-2 max-w-[85%]">
