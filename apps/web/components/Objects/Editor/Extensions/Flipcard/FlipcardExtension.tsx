    ...
    <NodeViewWrapper className={cn("flipcard-wrapper flex my-4", getAlignmentClass())}>
      <div className={cn("flipcard-container relative", getSizeClass())}>
        ...
        {isEditable && showColorPicker && (
          <div ref={colorPickerRef} className="absolute top-full mt-2 start-1/2 transform -translate-x-1/2 rtl:translate-x-1/2 p-3 bg-white rounded-lg nice-shadow z-10 border border-neutral-200">
