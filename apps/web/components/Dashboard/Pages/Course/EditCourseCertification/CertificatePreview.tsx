      ...
      case 'royal':
        return (
          <>
            ...
            <div className="absolute top-1 start-1/2 transform -translate-x-1/2 rtl:translate-x-1/2">
              <div className="w-8 h-4 bg-amber-200 opacity-50" style={{
                clipPath: 'polygon(0% 100%, 20% 0%, 40% 100%, 60% 0%, 80% 100%, 100% 0%, 100% 100%)'
              }}></div>
            </div>
            <div className="absolute bottom-1 start-1/2 transform -translate-x-1/2 rtl:translate-x-1/2 rotate-180">
              <div className="w-8 h-4 bg-amber-200 opacity-50" style={{
                clipPath: 'polygon(0% 100%, 20% 0%, 40% 100%, 60% 0%, 80% 100%, 100% 0%, 100% 100%)'
              }}></div>
            </div>
      ...
      case 'academic':
        return (
          <>
            ...
            <div className="absolute top-2 start-2 w-8 h-8 border-2 border-indigo-400 opacity-50 rounded-tl-lg"></div>
            <div className="absolute top-2 end-2 w-8 h-8 border-2 border-indigo-400 opacity-50 rounded-tr-lg"></div>
            <div className="absolute bottom-2 start-2 w-8 h-8 border-2 border-indigo-400 opacity-50 rounded-bl-lg"></div>
            <div className="absolute bottom-2 end-2 w-8 h-8 border-2 border-indigo-400 opacity-50 rounded-br-lg"></div>
          ...
          <div className="flex justify-center relative">
            <div className={`w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br ${theme.icon.replace('text-', 'from-')}-100 ${theme.icon.replace('text-', 'to-')}-200 rounded-full flex items-center justify-center relative`}>
              ...
              <div className="absolute inset-0 rounded-full">
                <div className={`absolute top-0 start-1/2 w-px h-2 sm:h-3 ${theme.secondary.replace('text-', 'bg-')} transform -translate-x-1/2 rtl:translate-x-1/2 -translate-y-1 opacity-60`}></div>
                <div className={`absolute bottom-0 start-1/2 w-px h-2 sm:h-3 ${theme.secondary.replace('text-', 'bg-')} transform -translate-x-1/2 rtl:translate-x-1/2 translate-y-1 opacity-60`}></div>
                <div className={`absolute start-0 top-1/2 w-2 sm:w-3 h-px ${theme.secondary.replace('text-', 'bg-')} transform -translate-y-1/2 -translate-x-1 rtl:translate-x-1 opacity-60`}></div>
