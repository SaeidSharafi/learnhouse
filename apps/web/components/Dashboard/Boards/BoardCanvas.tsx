  ...
  return (
    <>
      ...
      {connStatus === 'disconnected' && (
        <div className="fixed bottom-20 start-1/2 z-50 -translate-x-1/2 rtl:translate-x-1/2 flex items-center gap-2 rounded-full bg-amber-50 border border-amber-200 px-4 py-2 shadow-lg">
